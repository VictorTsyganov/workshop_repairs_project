"""
Django settings for workshop_repairs project.
...
SECRET_KEY = 'django-insecure-01%!l@cu9w8^tgsx@(92_6ga(ph!*bqo06k@t313lfrkdp-lk('
...
ALLOWED_HOSTS = [
    ...
    '[::1]',
    'testserver',
    'www.victortsyganov.pythonanywhere.com',
    'victortsyganov.pythonanywhere.com'
]
...
WSGI_APPLICATION = 'workshop_repairs.wsgi.application'

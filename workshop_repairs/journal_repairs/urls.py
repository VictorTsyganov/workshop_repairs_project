...
urlpatterns = [
    ...
    path(
        ...
        views.add_comment,
        name='add_comment'),
    path('repair/<int:repair_id>/edit/', views.repair_edit, name='repair_edit'),
    path('esn/<int:esn_id>/edit/<int:repair_id>/', views.esn_edit, name='esn_edit'),
    path('esn/<slug:slug>/', views.esn_repairs, name='esn_repairs'),
    path('customer/<slug:slug>/', views.customer_repairs, name='customer_repairs'),

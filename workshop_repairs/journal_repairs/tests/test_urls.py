...
from ..models import (EngineNumber, Customer, RepairType, AddressOperation,
                     Repair, Engine, Еquipment, EngineNumberRepair)
...
class JournalRepairUrlTest(TestCase):
    ...
    def setUp(self):
        ...
        self.esn_edit_page = f'/esn/{self.engine_number.id}/edit/{self.repair.id}/'
